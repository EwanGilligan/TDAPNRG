...
public class DeriveHypercube5DSp {
	...
	private double scale = 0.07; // lowest so far: 0.02, for LFSR: 0.15, for Minstd: 0.045
	...
	private double[] avg = { 11889,11671,11211,10367,8970,6922,4270,1825,630,196,57,18,5,2,1,1,1 };
    private double[] sdv = { 11,18,25,44,60,61,64,41,25,14,7,5,2,1,1,1,1 };
	...
	public void perform() {
		System.out.println("Hypercube Test, d = 5");
	...
	public static void main(String[] args) {
		new DeriveHypercube5DSp().perform();
	}

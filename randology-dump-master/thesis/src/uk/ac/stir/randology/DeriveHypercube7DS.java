...
public class DeriveHypercube7DS {
	...
	private double scale = 0.3; // for LFSR: 0.15, for Minstd: 0.045
	...
	public void perform() {
		System.out.println("Hypercube Test, d = 7, deriving phase START");
	...
	public static void main(String[] args) {
		new DeriveHypercube7DS().perform();
	}

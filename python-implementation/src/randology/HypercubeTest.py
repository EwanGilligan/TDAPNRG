...
from src.generator import RNG, FromBinaryFile
...
class HypercubeTest:
    ...
    def generate_distribution(self, rng: RNG.RNG):
        """
        Takes the random number generator, and then generates the distribution of betti numbers for that RNG.RNG.
    ...
    def single_run(self, rng: RNG.RNG, reference_distribution: np.array) -> float:
        """
    ...
    def perform_test(self, rng: RNG.RNG) -> int:
        """

...
public class DeriveHypercube8DSp {
	...
	private double scale = 0.3; // lowest so far: 0.02, for LFSR: 0.15, for Minstd: 0.045
	...
	private double[] avg = { 11998,11987,11948,11827,11517,10838,9505,7147,3853,1501,476,131,33,9,3,1,1 };
    private double[] sdv = { 2,3,9,13,25,29,42,60,61,28,20,12,6,3,1,1,1 };
	...
	public void perform() {
		System.out.println("Hypercube Test, d = 8");
	...
	public static void main(String[] args) {
		new DeriveHypercube8DSp().perform();
	}
